...
const Cart = () => {
  ...
  return (
    <>
      <div className="bg-white xs:m-0 m-[0rem 5rem]" >
        <div className="lg:container md:container sm:container mx-auto mt-10">
          <div className="flex shadow-md my-10 w-full md:flex-wrap sm:flex-wrap xs:flex-wrap ">
            <div className="lg:w-3/4 md:w-full sm:w-full bg-white px-10 xs:px-7 py-10">
              {/* left side */}
                ...
                {carts?.map((cart) => {
                  return (
                    <div
                      ...
                      key={cart?.id}
                    >
                      <div className="flex w-2/5 md:flex-wrap sm:flex-wrap xs:flex-wrap">
                        <div className="lg:w-20 md:w-full sm:w-full xs:w-full">
                          <img
                            className="h-24"
                            src={cart?.image}
                            alt={cart?.title}
            ...
            {/* right side */}
            <div id="summary" className="lg:w-1/4 md:w-full xs:w-full px-8 py-10">
